/*
아래의 코드 단위는 사물 자체가 아니라, 장차 사물을 대량으로 생산할 수 있는 툴이다
...
class Arrow{
    // 클래스 안에 선언된 변수는 ,이 클래스 소속이 되므로 변수명 앞에 자기 자신꺼라는 대명사를 붙어야 하며, this라는 이미 정해진 변수를 쓴다.
    // 소유권을 '주체'의 소유

    // ES 2015년에 발표된 js에 의해서,클래스가 소유한 변수는 constructor()라는 생성자 함수에 넣어둬야 한다.
    ...
    constructor(x,y){
        this.arrow;
        this.stepX=10;
        this.arrow=document.createElement("span"); //<span>
        this.arrow.innerText="→";//<span>→</span>
        this.arrow.style.fontSize=30+"px";
        this.arrow.style.color="coral";
